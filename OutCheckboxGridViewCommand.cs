    ...
    public class Out-CheckboxGridView : OutGridViewCommand
    {
        ...
        /// </summary>
        public OutCheckboxGridViewCommand()
        {
        }
        ...
        /// <summary>
        /// Specifies the property on the input object that will be used to dispaly a checkbox.
        /// </summary>
        [Parameter]
